...
@Component
public class TakeAnimalButton  implements Sender {
    private final ActionService actionService;
    private final StorageService storageService;
    private final EditTextResponse editTextResponse;

    @Autowired
    public TakeAnimalButton(ActionService actionService,
    ...
    public void execute(Message message) {
        Answer answer = actionService.rememberAction(message, Button.TAKE_ANIMAL);
        send(answer);
    }
    ...
    public void send(Answer answer) {
        ...
        InlineKeyboardMarkup keyboard = Keyboard.collectButtons(answer, Keyboard.TAKE_ANIMAL);
