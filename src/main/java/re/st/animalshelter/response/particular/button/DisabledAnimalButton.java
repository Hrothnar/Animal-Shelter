...
@Component
public class DisabledAnimalButton implements Sender {
    private final ActionService actionService;
    private final StorageService storageService;
    private final EditTextResponse editTextResponse;

    @Autowired
    public DisabledAnimalButton(ActionService actionService, StorageService storageService, EditTextResponse editTextResponse) {
    ...
    public void execute(Message message) {
        Answer answer = actionService.rememberAction(message, Button.DISABLED_ANIMAL);
        send(answer);
    }
