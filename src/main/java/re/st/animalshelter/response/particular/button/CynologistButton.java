...
@Component
public class CynologistButton implements Sender {
    private final ActionService actionService;
    private final StorageService storageService;
    private final EditTextResponse editTextResponse;

    @Autowired
    public CynologistButton(ActionService actionService, StorageService storageService, EditTextResponse editTextResponse) {
    ...
    public void execute(Message message) {
        Answer answer = actionService.rememberAction(message, Button.CYNOLOGIST);
        send(answer);
    }
