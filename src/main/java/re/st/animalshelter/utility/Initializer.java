...
import re.st.animalshelter.model.response.particular.button.*;
import re.st.animalshelter.model.response.particular.command.FinishCommand;
import re.st.animalshelter.model.response.particular.command.StartCommand;
import re.st.animalshelter.model.response.particular.status.*;
