...
public class AddButtonUtil {
    ...
    public AddButtonUtil(ActionService actionService) {
        this.actionService = actionService;
    }

    public InlineKeyboardMarkup getKeyboard(Action action, boolean owner) {
        Button button = action.getButton();
        if (button.equals(Button.BACK)) {
            button = actionService.getLastDialog(action.getMessageId()).getButton();
        }
